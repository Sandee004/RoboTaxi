    ...
    <>
      ...
      <main className="pt-18 bg-[#0cc0df]">
        <div className="relative w-full">
          ...
          <div className="absolute top-[85%] left-1/2 flex flex-col w-full justify-center px-4 transform -translate-x-1/2 -translate-y-1/2">
        ...
        <div className="flex justify-center border-b border-[#39437E] pb-5 mt-18 items-center flex-col">
          <div
