    ...
    <>
      ...
      <main className="pt-18 bg-[#0cc0df]">
        <div className="relative w-full">
          ...
          <div className="absolute top-[82%] left-1/2 flex flex-col w-full justify-center px-4 transform -translate-x-1/2 -translate-y-1/2">
          ...
          active:translate-y-1 active:shadow-none active:border-b-0"
            ...
            <div className="flex flex-col mt-8 mb-5 items-center justify-center">
        ...
        <div className="flex justify-center border-b border-[#39437E] pb-5 mt-12 items-center flex-col">
          <div
