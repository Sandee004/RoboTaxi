      ...
      <div className="container mx-auto px-4 sm:px-6">
        <div className="mb-12 text-center">
          ...
          <p className="mx-auto max-w-2xl text-lg text-gray-600">
            CryptoNexus is available on the world's leading cryptocurrency
            exchanges
          </p>
        </div>
        ...
        <div className="relative mx-auto max-w-4xl">
            ...
            {exchanges.map((exchange, index) => (
              ...
              >
                ...
                <div className="relative z-10 flex h-full flex-col items-center justify-center">
                  <div className="mb-4 h-12 w-auto object-contain"></div>
          ...
          <div className="mt-12 flex justify-center">
            <div className="relative overflow-hidden rounded-xl">
              <div className="rounded-xl object-cover transition-transform duration-500 hover:scale-105"></div>
              <div className="absolute inset-0 bg-gradient-to-r from-blue-600/70 to-blue-800/70 p-8 text-white">
                <div className="flex h-full flex-col items-start justify-center">
                  ...
                  <p className="mb-6 max-w-md">
                    CryptoNexus is available in over 150 countries, making it
                    one of the most accessible tokens in the market.
                  </p>
                  <div className="bg-yellow-400 text-blue-900 hover:bg-yellow-300">
